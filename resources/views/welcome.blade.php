    ...
    {{-- <div class="md:py-24 py-5">
      <div class="container px-8 mx-auto">
        ...
        <div class="grid grid-flow-col grid-rows-2 grid-cols-3 gap-8">
          <div>
            <img src="{{asset('/images/guest1.jpg')}}"alt="" loading="lazy">
          </div>
          <div class="col-start-3">
            <img src="{{asset('/images/guest2.jpg')}}" alt="" loading="lazy">
          </div>
          <div>
            <img src="{{asset('/images/guest3.jpg')}}" alt="" loading="lazy">
          </div>
          <div>
            <img src="{{asset('/images/guest4.jpg')}}" alt="" loading="lazy">
          </div>
          <div class="col-start-3">
            <img src="{{asset('/images/guest2.jpg')}}" alt="" loading="lazy">
          </div>
          ...
          <div class="row-start-1 col-start-2 col-span-2">
            <img src="{{asset('/images/guest5.jpg')}}" alt="" loading="lazy">
          </div>
