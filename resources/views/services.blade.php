   ...
   --}}
    ...
    {{-- KINDERGARTEN MODAL BUTTON --}}
      ...
      {{-- ELEM SCHOOL MODAL BUTTON --}}
           ...
           <section style="margin-bottom: 10rem"  class="ml-20 mb-20 text-gray-700">
             
            
            <div style="width: 100%; margin-left:145px;" class=" text-center">
              
              <div>
                <div style="margin-left: -5%; margin-right:-25%; margin-top:5%;" class="block rounded-lg shadow-lg bg-white">
                  <div class="p-6">
